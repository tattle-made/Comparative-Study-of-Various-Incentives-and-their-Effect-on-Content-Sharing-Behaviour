  ...
  return (
    <Box>
      ...
      <Paragraph fill>
        ...
        messages within our platform. On the first day, we will see how you
        naturally share content. On second and third days, you will be rewarded
        for sharing true content by adding Rs 10 in your wallet and penalised
        for sharing false content by deduction of Rs 4 from your wallet. You
  ...
  return (
    <Box>
      ...
      <Paragraph fill>
        ...
        messages within our platform. On the first day, we will see how you
        naturally share content. On second and third days, you will be rewarded
        for sharing true content; you will get 100 followers for sharing true
        content. You will be penalised for sharing false content by deduction of
        40 followers. You will have to read the message thoroughly and use your
        judgement to classify which content is true, which is false, and which
        would spread joy.
      </Paragraph>
      <Box width={"large"}>
